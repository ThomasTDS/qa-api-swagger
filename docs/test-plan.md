...
| TC-019 | GET /posts              | Cada post da lista possui os campos obrigatórios                  | Positivo | Todos os itens têm id/user_id/title/body válidos          | [posts.get.positive.test.js](../tests/posts.get.positive.test.js)     |
| TC-020 | GET /posts/{id}         | Buscar um post existente por ID                                   | Positivo | 200 + dados batendo com o post esperado                  | [posts.get.positive.test.js](../tests/posts.get.positive.test.js)     |
| TC-021 | GET /users/{id}/posts   | Listar os posts de um usuário específico (endpoint aninhado)      | Positivo | 200 + todos os itens com o `user_id` informado            | [posts.get.positive.test.js](../tests/posts.get.positive.test.js)     |
| TC-022 | GET /posts/{id}         | Buscar um ID inexistente (ex.: `1`)                                | Negativo | 404 + `{"message":"Resource not found"}`                  | [posts.get.negative.test.js](../tests/posts.get.negative.test.js)     |
| TC-023 | GET /posts/{id}         | Buscar um ID em formato inválido (ex.: `abc`)                      | Negativo | 404                                                    | [posts.get.negative.test.js](../tests/posts.get.negative.test.js)     |
| TC-024 | POST /posts             | Criar post sem enviar token de autenticação                       | Negativo | 401 + `{"message":"Authentication failed"}`               | [posts.get.negative.test.js](../tests/posts.get.negative.test.js)     |
| TC-025 | POST /posts             | Criar um post com dados válidos                                   | Positivo | 201 + post criado com os dados enviados                  | [posts.write.positive.test.js](../tests/posts.write.positive.test.js) |
| TC-026 | PUT /posts/{id}         | Atualizar um post existente                                       | Positivo | 200 + campo atualizado refletido na resposta              | [posts.write.positive.test.js](../tests/posts.write.positive.test.js) |
| TC-027 | DELETE /posts/{id}      | Remover um post existente                                         | Positivo | 204, e um GET subsequente no mesmo ID retorna 404          | [posts.write.positive.test.js](../tests/posts.write.positive.test.js) |
| TC-028 | POST /posts             | Criar post sem o campo obrigatório `title`                        | Negativo | 422 + erro de validação apontando o campo `title`         | [posts.write.negative.test.js](../tests/posts.write.negative.test.js) |
| TC-029 | POST /posts             | Criar post com `user_id` que não corresponde a um usuário existente | Negativo | 422 + `{"field":"user","message":"must exist"}`          | [posts.write.negative.test.js](../tests/posts.write.negative.test.js) |
| TC-030 | PUT /posts/{id}         | Atualizar um ID inexistente                                       | Negativo | 404                                                    | [posts.write.negative.test.js](../tests/posts.write.negative.test.js) |
| TC-031 | DELETE /posts/{id}      | Remover um ID inexistente                                         | Negativo | 404                                                    | [posts.write.negative.test.js](../tests/posts.write.negative.test.js) |

Todos os 14 casos (TC-018 a TC-031) foram executados com sucesso contra a API
...
| ID     | Endpoint                | Cenário                                                            | Tipo     | Resultado esperado                                | Arquivo                                                              |
| ------ | ------------------------ | --------------------------------------------------------------------- | -------- | ------------------------------------------------------ | ------------------------------------------------------------------------- |
| TC-032 | GET /comments             | Listar comments na primeira página                                   | Positivo | 200 + lista não vazia                                   | [comments.get.positive.test.js](../tests/comments.get.positive.test.js)   |
| TC-033 | GET /comments             | Cada comment da lista possui os campos obrigatórios                  | Positivo | Todos os itens têm id/post_id/name/email/body válidos     | [comments.get.positive.test.js](../tests/comments.get.positive.test.js)   |
| TC-034 | GET /comments/{id}        | Buscar um comment existente por ID                                   | Positivo | 200 + dados batendo com o comment esperado                | [comments.get.positive.test.js](../tests/comments.get.positive.test.js)   |
| TC-035 | GET /posts/{id}/comments  | Listar os comments de um post específico (endpoint aninhado)         | Positivo | 200 + todos os itens com o `post_id` informado             | [comments.get.positive.test.js](../tests/comments.get.positive.test.js)   |
| TC-036 | GET /comments/{id}        | Buscar um ID inexistente (ex.: `1`)                                   | Negativo | 404 + `{"message":"Resource not found"}`                   | [comments.get.negative.test.js](../tests/comments.get.negative.test.js)   |
| TC-037 | GET /comments/{id}        | Buscar um ID em formato inválido (ex.: `abc`)                         | Negativo | 404                                                     | [comments.get.negative.test.js](../tests/comments.get.negative.test.js)   |
| TC-038 | POST /comments            | Criar comment sem enviar token de autenticação                       | Negativo | 401 + `{"message":"Authentication failed"}`                | [comments.get.negative.test.js](../tests/comments.get.negative.test.js)   |
| TC-039 | POST /comments            | Criar um comment com dados válidos                                   | Positivo | 201 + comment criado com os dados enviados                | [comments.write.positive.test.js](../tests/comments.write.positive.test.js) |
| TC-040 | PUT /comments/{id}        | Atualizar um comment existente                                       | Positivo | 200 + campo atualizado refletido na resposta               | [comments.write.positive.test.js](../tests/comments.write.positive.test.js) |
| TC-041 | DELETE /comments/{id}     | Remover um comment existente                                         | Positivo | 204, e um GET subsequente no mesmo ID retorna 404           | [comments.write.positive.test.js](../tests/comments.write.positive.test.js) |
| TC-042 | POST /comments            | Criar comment sem o campo obrigatório `body`                         | Negativo | 422 + erro de validação apontando o campo `body`           | [comments.write.negative.test.js](../tests/comments.write.negative.test.js) |
| TC-043 | POST /comments            | Criar comment com `post_id` que não corresponde a um post existente  | Negativo | 422 + `{"field":"post","message":"must exist"}`            | [comments.write.negative.test.js](../tests/comments.write.negative.test.js) |
| TC-044 | PUT /comments/{id}        | Atualizar um ID inexistente                                          | Negativo | 404                                                     | [comments.write.negative.test.js](../tests/comments.write.negative.test.js) |
| TC-045 | DELETE /comments/{id}     | Remover um ID inexistente                                            | Negativo | 404                                                     | [comments.write.negative.test.js](../tests/comments.write.negative.test.js) |

Todos os 14 casos (TC-032 a TC-045) foram executados com sucesso contra a API
real, incluindo os autenticados.
...
| ID     | Endpoint             | Cenário                                                          | Tipo     | Resultado esperado                                | Arquivo                                                        |
| ------ | --------------------- | --------------------------------------------------------------------- | -------- | ------------------------------------------------------ | --------------------------------------------------------------------- |
| TC-046 | GET /todos             | Listar todos na primeira página                                       | Positivo | 200 + lista não vazia                                   | [todos.get.positive.test.js](../tests/todos.get.positive.test.js)     |
| TC-047 | GET /todos             | Cada todo da lista possui os campos obrigatórios                      | Positivo | Todos os itens têm id/user_id/title/due_on/status válidos  | [todos.get.positive.test.js](../tests/todos.get.positive.test.js)     |
| TC-048 | GET /todos/{id}        | Buscar um todo existente por ID                                       | Positivo | 200 + dados batendo com o todo esperado                  | [todos.get.positive.test.js](../tests/todos.get.positive.test.js)     |
| TC-049 | GET /users/{id}/todos  | Listar os todos de um usuário específico (endpoint aninhado)          | Positivo | 200 + todos os itens com o `user_id` informado            | [todos.get.positive.test.js](../tests/todos.get.positive.test.js)     |
| TC-050 | GET /todos/{id}        | Buscar um ID inexistente (ex.: `1`)                                    | Negativo | 404 + `{"message":"Resource not found"}`                   | [todos.get.negative.test.js](../tests/todos.get.negative.test.js)     |
| TC-051 | GET /todos/{id}        | Buscar um ID em formato inválido (ex.: `abc`)                          | Negativo | 404                                                     | [todos.get.negative.test.js](../tests/todos.get.negative.test.js)     |
| TC-052 | POST /todos            | Criar todo sem enviar token de autenticação                           | Negativo | 401 + `{"message":"Authentication failed"}`                | [todos.get.negative.test.js](../tests/todos.get.negative.test.js)     |
| TC-053 | POST /todos            | Criar um todo com dados válidos                                       | Positivo | 201 + todo criado com os dados enviados                   | [todos.write.positive.test.js](../tests/todos.write.positive.test.js) |
| TC-054 | PUT /todos/{id}        | Atualizar o status de um todo existente                               | Positivo | 200 + status atualizado refletido na resposta              | [todos.write.positive.test.js](../tests/todos.write.positive.test.js) |
| TC-055 | DELETE /todos/{id}     | Remover um todo existente                                             | Positivo | 204, e um GET subsequente no mesmo ID retorna 404           | [todos.write.positive.test.js](../tests/todos.write.positive.test.js) |
| TC-056 | POST /todos            | Criar todo sem o campo obrigatório `title`                            | Negativo | 422 + erro de validação apontando o campo `title`          | [todos.write.negative.test.js](../tests/todos.write.negative.test.js) |
| TC-057 | POST /todos            | Criar todo com `status` fora do enum permitido                        | Negativo | 422 + erro de validação apontando o campo `status`         | [todos.write.negative.test.js](../tests/todos.write.negative.test.js) |
| TC-058 | POST /todos            | Criar todo com `user_id` que não corresponde a um usuário existente   | Negativo | 422 + `{"field":"user","message":"must exist"}`            | [todos.write.negative.test.js](../tests/todos.write.negative.test.js) |
| TC-059 | PUT /todos/{id}        | Atualizar um ID inexistente                                           | Negativo | 404                                                     | [todos.write.negative.test.js](../tests/todos.write.negative.test.js) |
| TC-060 | DELETE /todos/{id}     | Remover um ID inexistente                                             | Negativo | 404                                                     | [todos.write.negative.test.js](../tests/todos.write.negative.test.js) |

Todos os 15 casos (TC-046 a TC-060) foram executados com sucesso contra a API
real, incluindo os autenticados.
